  ...
  return (
    <>
      ...
      <button
        ...
        title="Open Islamic Numerology Glossary"
      >
      ...
      {isOpen && (
        <div className="fixed inset-4 md:inset-12 bg-white rounded-lg shadow-xl z-50 flex flex-col overflow-hidden">
          ...
          <div className="border-b border-slate-200 px-6 py-4 bg-slate-50">
            <input
              type="text"
              placeholder="Search terms... (e.g., 'Saghir', 'element', 'destiny')"
              value={searchTerm}
            ...
            <div className="space-y-6">
              {filteredTerms.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <p className="text-slate-600">No terms found matching "{searchTerm}"</p>
