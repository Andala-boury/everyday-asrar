    ...
    <div className="flex items-center justify-center gap-4 p-4 bg-gray-100 dark:bg-slate-800 rounded-lg">
      ...
      >
        ...
        <div className="text-left">
          <div className="text-sm">Transit Mode</div>
          <div className="text-xs opacity-80">Planetary Hours</div>
        </div>
      </button>
      ...
      >
        ...
        <div className="text-left">
          <div className="text-sm">Relationship Mode</div>
          <div className="text-xs opacity-80">Name Compatibility</div>
        </div>
      </button>
